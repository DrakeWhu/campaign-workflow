...
class ReducedValidationTests(unittest.TestCase):
    ...
    def test_successful_reduced_validation_writes_summary_and_state(self) -> None:
        ...
        self.assertEqual(validation["reduced"]["fake_metrics"]["columns"], ["iteration", "score"])
        self.assertEqual(validation["reduced"]["fake_metrics"]["file"]["relative_path"], "post/fake_metrics.csv")
    ...
    def test_dry_run_does_not_change_state_or_validation(self) -> None:
        ...
        rc = validate_reduced_case_main(["--campaign-root", str(self.root), "--case-id", "0", "--dry-run"])
